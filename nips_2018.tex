...
Spike-sorting is an essential component of modern electrophysiological data processing.
Extracellular recordings take the form of voltage time series, with one waveform from each electrode.
Action potentials (``spikes'') in the waveforms must be identified,
as well as from which cell the spike originates.
The first task is well-studied, and can be managed effectively by high-pass filtering and counting threshold crossings.
