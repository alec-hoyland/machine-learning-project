...
which must be solved during optimizing the embedding, yielding time-complexity $\mathcal{O}(n \log n)$.
...
FIt-SNE uses an approximate nearest-neighbors algorithm, \texttt{ANNOY} (cite),
...
Furthermore, it is deterministic and therefore allows new data to be added to embedded
